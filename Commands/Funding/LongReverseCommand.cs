...
public class LongReverseCommand : BaseCommand
{
    public override string Name => "/long_reverse";
    ...
    public override async Task ExecuteAsync(Message message, Core.User currentUser, CancellationToken cancellationToken)
    {
        ...
        await LiquidationNotifier.SendTopLiquidationData(LiquidationLevelTopType.LongReverseNarrative, message.Chat.Id);
    }
}
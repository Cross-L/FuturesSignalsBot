...
public class MaxExtremeCorrelationCommand: BaseCommand
{
    public override string Name => "/max_correlation";
    ...
    public override async Task ExecuteAsync(Message message, User currentUser, CancellationToken cancellationToken)
    {
        ...
        await ResistanceNotifier.SendTopCorrelationData(CorrelationType.MaxExtremeCorrelation, message.Chat.Id);
    }
}
...
public class MinExtremeCorrelationCommand: BaseCommand
{
    public override string Name => "/min_correlation";
        ...
        CancellationToken cancellationToken)
    {
        ...
        await ResistanceNotifier.SendTopCorrelationData(CorrelationType.MinExtremeCorrelation, message.Chat.Id);
    }
}
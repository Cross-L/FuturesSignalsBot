...
public class SeriesCorrelationCommand: BaseCommand
{
    public override string Name => "/series_correlation";
        ...
        CancellationToken cancellationToken)
    {
        ...
        await ResistanceNotifier.SendTopCorrelationData(CorrelationType.MaxSeriesCorrelation, message.Chat.Id);
    }
}
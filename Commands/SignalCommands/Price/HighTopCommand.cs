...
public class HighTopCommand: BaseCommand
{
    public override string Name => "/high_top";
        ...
        CancellationToken cancellationToken)
    {
        ...
        await LiquidationNotifier.SendTopLiquidationData(LiquidationLevelTopType.High, message.Chat.Id);
    }
}
...
public class LongOpenMaxCommand: BaseCommand
{
    public override string Name => "/long_open_max";
    ...
    public override async Task ExecuteAsync(Message message, User currentUser, CancellationToken cancellationToken)
    {
        ...
        await LiquidationNotifier.SendTopLiquidationData(LiquidationLevelTopType.LongOpenMax, message.Chat.Id);
    }
}
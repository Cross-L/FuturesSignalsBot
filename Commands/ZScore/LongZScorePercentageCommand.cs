...
public class LongZScorePercentageCommand: BaseCommand
{
    public override string Name => "/long_deliq";
    ...
    public override async Task ExecuteAsync(Message message, User currentUser, CancellationToken cancellationToken)
    {
        ...
        await LiquidationNotifier.SendTopLiquidationData(LiquidationLevelTopType.LongZScorePercentage, message.Chat.Id);
    }
}
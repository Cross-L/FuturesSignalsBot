...
public class ShortZScorePercentageCommand: BaseCommand
{
    public override string Name => "/short_deliq";
    ...
    public override async Task ExecuteAsync(Message message, User currentUser, CancellationToken cancellationToken)
    {
        ...
        await LiquidationNotifier.SendTopLiquidationData(LiquidationLevelTopType.ShortZScorePercentage, message.Chat.Id);
    }
}
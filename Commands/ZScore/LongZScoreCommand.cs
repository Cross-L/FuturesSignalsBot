...
public class LongZScoreCommand: BaseCommand
{
    public override string Name => "/long_score";
    ...
    public override async Task ExecuteAsync(Message message, User currentUser, CancellationToken cancellationToken)
    {
        ...
        await LiquidationNotifier.SendTopLiquidationData(LiquidationLevelTopType.LongZScore, message.Chat.Id);
    }
}